...
<head>
    ...
    <title>Yarvis AI - Asistente de Voz Interactivo</title>
    <style>
...
<body>
    <div class="container">
        <h1>🎙️ Yarvis AI - Interfaz de Voz</h1>
    ...
    <script>
        ...
        function alternarMicrofono() {
            ...
            if (!meEstaEscuchando) {
                detenerVoz(); // Detiene cualquier audio en reproducción antes de escuchar
        ...
        // Enviar la pregunta procesada al servidor Python (Backend)
        ...
        // Síntesis de voz (Speech Synthesis) para hablar
...
# RUTA API PARA PROCESAR EL TEXTO ENVIADO DESDE EL MICRÓFONO WEB
...
def bucle_auto_aprendizaje():
    while True:
        time.sleep(900)  # Revisa cada 15 minutos para optimizar la cuota
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("¡Yarvis Online 24/7 en Render! Servidor web con micrófono y bot activos.")
