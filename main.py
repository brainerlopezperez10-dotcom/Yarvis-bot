    ...
    try:
        ...
        if not ai_model:
            ...
            if modelos_disponibles:
                ai_model = genai.GenerativeModel(modelos_disponibles[0])
                print(f"✅ Conectado al modelo disponible: {modelos_disponibles[0]}")
...
# Hilos para ejecutar Web y Auto-aprendizaje en paralelo
...
if __name__ == "__main__":
    ...
    print("=== YARVIS ONLINE EN LA NUBE ===")
